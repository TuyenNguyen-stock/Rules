    ...
    <div className="flex flex-col gap-4 w-full max-w-sm">
      ...
      <div className="flex gap-2">
        <input
          ...
          className={`flex-1 bg-slate-800 border border-slate-600 rounded-lg px-3 py-2 outline-none focus:border-blue-500 uppercase font-mono tracking-widest ${joinId ? 'border-green-500 bg-green-900/20' : ''}`}
          maxLength={6}
        />
        <button
